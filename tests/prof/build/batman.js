...
(function() {
  ...
  Batman.SimpleSet = (function() {
    ...
    SimpleSet.prototype.add = function() {
      ...
      return Batman.SimpleSet.prototype.addArray.call(this, items);
    };
  ...
  Batman.StorageAdapter = (function(_super) {
    ...
    StorageAdapter.StorageError = (function(_super1) {
      ...
      StorageError.prototype.toJSON = function() {
        var action, json, request, subject, _ref;
        ...
        if (request = (_ref = this.request) != null ? _ref.toJSON() : void 0) {
          delete request.xhr;
    ...
    RestStorage.ModelMixin = Batman.extend({}, RestStorage.BaseMixin, {
      urlNestsUnder: function() {
        ...
        this.url = function(options) {
          ...
          for (key in parents) {
            plural = parents[key];
            if (Batman.typeOf(plural) === 'Object') {
...
(function() {
  ...
  Batman.Set = (function(_super) {
    ...
    function Set(items) {
      ...
      Batman.SimpleSet.call(this, items);
    }
    ...
    Set.prototype.addArray = Set.mutation(function() {
      var addedItems;
      addedItems = Batman.SimpleSet.prototype.addArray.apply(this, arguments);
    ...
    Set.prototype.removeArrayWithIndexes = Set.mutation(function(items) {
      ...
      _ref2 = Batman.SimpleSet.prototype.removeArrayWithIndexes.call(this, items), removedItems = _ref2.removedItems, removedIndexes = _ref2.removedIndexes;
  ...
  Batman.Model = (function(_super) {
    ...
    Model.classAccessor('resourceName', {
      get: function() {
        if (this.resourceName != null) {
          ...
          if (Batman.config.minificationErrors) {
            Batman.developer.error("Please define the resourceName property of the " + (Batman.functionName(this)) + " on the constructor and not the prototype. (For example, `@resourceName: '" + (Batman.helpers.underscore(Batman.functionName(this))) + "'`)");
          }
          return this.prototype.resourceName;
        } else {
          if (Batman.config.minificationErrors) {
            Batman.developer.error("Please define " + (Batman.functionName(this)) + ".resourceName in order for your model to be minification safe. (For example, `@resourceName: '" + (Batman.helpers.underscore(Batman.functionName(this))) + "'`)");
          }
    ...
    Model.prototype.destroy = function(options, callback) {
      ...
      if (this.get('lifecycle').destroy()) {
        payload = Batman.mixin({}, options, {
          data: options
        });
        return this._doStorageOperation('destroy', payload, (function(_this) {
          return function(err, record, env) {
            if (!err) {
    ...
    Model.prototype._transaction = function(visited, stack) {
      ...
      for (key in attributes) {
        ...
        if (value instanceof Batman.Model && !value.isTransaction) {
          ...
          Batman.developer.warn("You're passing a mutable object (" + key + ", " + (Batman.functionName(value.constructor)) + ") in a " + this.constructor.name + " transaction:", value);
        }
      }
...
(function() {
  ...
  Batman.SetSort = (function(_super) {
    ...
    SetSort.prototype.merge = function(other) {
      this.base.registerAsMutableSource();
      return new Batman.Set(this._storage).merge(other).sortedBy(this.key, this.order);
    };
  ...
  Batman.Association = (function() {
    ...
    function Association(model, label, options) {
      ...
      if (this.options.nestUrl) {
        if (this.model.urlNestsUnder == null) {
          Batman.developer.error("You must persist the model " + (Batman.functionName(this.model)) + " to use the url helpers on an association");
        }
    ...
    Association.prototype.getRelatedModel = function() {
      ...
      Batman.developer["do"](function() {
        var namespaceMsg, _ref;
        if (!relatedModel && Batman.env !== 'test') {
          namespaceMsg = ((_ref = this.options) != null ? _ref.namespace : void 0) ? "" + this.options.namespace + "." : "Batman.currentApp. Is your app running with `MyApp.run()`?";
          return Batman.developer.warn("Related model " + className + " wasn't found in namespace " + namespaceMsg);
        }
      });
      return relatedModel;
    };
  ...
  Batman.HasManyAssociation = (function(_super) {
    ...
    HasManyAssociation.prototype.decoder = function() {
      ...
      return function(data, key, _, __, parentRecord) {
        var children, i, id, jsonObject, newChildren, record, recordsToAdd, recordsToMap, relatedModel, _ref;
...
(function() {
  ...
  Batman.TransactionAssociationSet = (function(_super) {
    ...
    TransactionAssociationSet.prototype.applyChanges = function(visited) {
      ...
      originals = new Batman.Set(this._originalStorage);
...
(function() {
  ...
  (function() {
    ...
    _ref = ['capitalize', 'titlelize', 'singularize', 'underscore', 'camelize', 'toSentence', 'ordinalize'];
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      k = _ref[_i];
